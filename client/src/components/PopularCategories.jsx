      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-4 gap-5 md:grid-cols-2 sm:grid-cols-1">
          {categories.map((cat) => (
            ...
            >
              <div className="w-14 h-14 bg-[#eef1fb] dark:bg-[#222a40] rounded-full flex items-center justify-center mb-3 transition-colors group-hover:bg-[#2c3fd1] dark:group-hover:bg-[#2c3fd1] group-hover:text-white dark:group-hover:text-white">
