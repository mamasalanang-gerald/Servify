...
import ViewService from './ViewService';                            // added import
import '../pages/styles/SavedServices.css';
...
const SavedServices = () => {
  const [viewingService, setViewingService] = useState(null);     // added state

  // When a card is clicked, swap to ViewService                   // added block
  if (viewingService) {
  ...
  return (
    <div className="dash-section">
      <h2 className="dash-section__title">Saved Services</h2>
      <div className="saved-services__grid">
        {savedServices.map((service) => (
          <div className="saved-card" key={service.id}>
            <div className="saved-card__img-wrapper">
              <img src={service.img} alt={service.title} className="saved-card__img" />
              <button className="saved-card__heart" aria-label="Remove from saved">
            ...
            <div className="saved-card__body">
              <h3 className="saved-card__title">{service.title}</h3>
              <div className="saved-card__meta">
                <span className="saved-card__rating">
                ...
                <span className="saved-card__price">From {service.price}</span>
              </div>
              <button className="saved-card__btn" onClick={() => setViewingService(service)}> {/* added onClick */}
                View Service
              </button>
            </div>
          </div>
