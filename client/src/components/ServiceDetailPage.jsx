...
export default function ServiceDetailPage({ service, onBack }) {
  ...
  const packages = service?.packages || [
    { name: "Basic Clean", price: 89, description: "Essential cleaning for small apartments", features: ["Living room & bedroom", "Kitchen surfaces", "Bathroom", "2-3 hours"] },
    { name: "Standard Clean", price: 149, description: "Complete cleaning for medium homes", features: ["All rooms", "Kitchen & appliances", "Bathrooms", "Dusting & vacuuming", "4-5 hours"] },
    { name: "Premium Clean", price: 249, description: "Intensive deep cleaning", features: ["Deep scrubbing", "Carpet cleaning", "Window cleaning", "Organizing", "6-8 hours"] },
  ];
      ...
      <div className="sdp__layout">
        ...
        <div className="sdp__left">
          ...
          <div className="sdp__provider">
            <div className="sdp__provider-avatar">{service?.initials ?? "SJ"}</div>
            <div className="sdp__provider-info">
              <div className="sdp__provider-name">
                {service?.provider ?? "Sarah Johnson"}
        ...
        <div className="sdp__right">
          <div className="sdp__panel">
            ...
            <button className="sdp__book-btn">
